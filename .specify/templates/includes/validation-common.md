...
1. **Check File Exists**: Verify `.specify/memory/git-workflow.yaml` exists
...
Required file: .specify/memory/git-workflow.yaml
...
Branching Standards: .specify/memory/git-workflow.yaml
